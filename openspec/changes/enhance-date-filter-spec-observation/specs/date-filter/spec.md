...
The system SHALL initialize with a default date range of January 1, 2024 to December 31, 2024 to align with mock data availability and provide consistent initial analytics.

#### Scenario: Dashboard initial load
- **GIVEN** a user loads the dashboard for the first time
- **WHEN** the dashboard initializes
- **THEN** the Date Range Picker displays "Jan 1, 2024 - Dec 31, 2024" as the selected range
- **AND** all metrics show data filtered to this 2024 calendar year
